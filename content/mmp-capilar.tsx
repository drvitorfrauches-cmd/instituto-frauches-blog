...
export const meta: PostMeta = {
  ...
  coverImage: {
    ...
    alt: "Imagem editorial ilustrando o tema: MMP capilar: o que é, indicações, resultados e riscos",
  },
};
...
export default function Article() {
  return (
    <>
      ...
      <UL>
        <LI><a href="https://pubmed.ncbi.nlm.nih.gov/37665358/" target="_blank" rel="noopener noreferrer" className="underline">Abdi P et al. Topical minoxidil and microneedling for androgenetic alopecia.</a></LI>
