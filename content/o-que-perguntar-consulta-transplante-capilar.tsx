...
export default function Article() {
  return (
    <>
      ...
      <UL>
        <LI><a href="https://ishrs.org/questions-ask-your-hair-doctor/" className="underline" target="_blank" rel="noopener noreferrer">{"International Society of Hair Restoration Surgery. Questions to Ask Your Hair Restoration Surgeon."}</a></LI>
        ...
        <LI><a href="https://portal.cfm.org.br/busca-medicos/" className="underline" target="_blank" rel="noopener noreferrer">{"Conselho Federal de Medicina. Busca por médicos."}</a></LI>
      </UL>
      <P>{"Se você quer se aprofundar, veja também nossos artigos sobre "}<Link href="/blog/como-escolher-clinica-transplante-capilar" className="underline">{"como escolher uma clínica de transplante capilar"}</Link>{" e sobre "}<Link href="/blog/exames-antes-do-transplante-capilar" className="underline">{"quais exames pedir antes da cirurgia"}</Link>{". Para entender como isso se aplica ao seu caso, o próximo passo é uma avaliação com o Dr. Vitor Frauches. "}<a href={WHATSAPP_URL} className="underline" target="_blank" rel="noopener noreferrer"><Strong>{"Agende pelo WhatsApp"}</Strong></a>{"."}</P>
