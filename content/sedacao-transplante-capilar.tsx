...
export default function Article() {
  return (
    <>
      ...
      <UL>
        <LI><a href="https://www.asahq.org/standards-and-practice-parameters" target="_blank" rel="noopener noreferrer" className="underline">American Society of Anesthesiologists. Standards and Practice Parameters.</a></LI>
        <LI><a href="https://pubmed.ncbi.nlm.nih.gov/30235369/" target="_blank" rel="noopener noreferrer" className="underline">Sedation in hair transplantation.</a></LI>
