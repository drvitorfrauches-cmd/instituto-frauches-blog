...
export default function Article() {
  return (
    <>
      ...
      <UL>
        <LI><a href="https://www.fda.gov/vaccines-blood-biologics/safety-availability-biologics/public-safety-notification-exosome-products" target="_blank" rel="noopener noreferrer" className="underline">FDA. Public Safety Notification on Exosome Products.</a></LI>
        <LI><a href="https://pubmed.ncbi.nlm.nih.gov/38514762/" target="_blank" rel="noopener noreferrer" className="underline">Systematic review of extracellular vesicles for hair loss.</a></LI>
        <LI><a href="https://pubmed.ncbi.nlm.nih.gov/39343670/" target="_blank" rel="noopener noreferrer" className="underline">Extracellular vesicle therapy in hair regeneration.</a></LI>
        <LI><a href="https://www.gov.br/anvisa/pt-br/assuntos/sangue/terapias-avancadas" target="_blank" rel="noopener noreferrer" className="underline">Anvisa. Produtos de terapias avançadas e alertas sanitários.</a></LI>
