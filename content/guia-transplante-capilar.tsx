...
export default function Article() {
  return (
    <>
      <P>
        Transplante capilar envolve decisões em sequência: entender a
        técnica, avaliar a área doadora, planejar a linha frontal, entender o
        que esperar de dor e recuperação, e só depois chegar ao resultado
        final. Este guia organiza os artigos do blog na ordem em que essas
      ...
      <UL>
        <LI>
          ...
          guia completo sobre a técnica, do início ao fim.
        </LI>
        <LI>
          <Link href="/blog/tecnica-fue-transplante-capilar" className="underline">
            Como funciona a técnica FUE
          </Link>:{" "}
          extração, punch, cicatrizes e diferenças para a FUT.
        </LI>
        <LI>
          <Link href="/blog/fue-ou-fut" className="underline">
            FUE ou FUT
          </Link>:{" "}
          qual a diferença e por que a FUE é hoje a mais usada.
        </LI>
        <LI>
      ...
      <UL>
        <LI>
          ...
          por que ela é limitada e como se preserva.
        </LI>
        <LI>
          <Link href="/blog/hairline-natural-transplante-capilar" className="underline">
            Hairline natural
          </Link>:{" "}
          como é desenhada a linha frontal.
        </LI>
        <LI>
          ...
          os sinais de um bom planejamento.
        </LI>
      </UL>
      ...
      <UL>
        <LI>
          ...
          o que define o preço, e por que desconfiar de valores muito baixos.
        </LI>
        <LI>
      ...
      <UL>
        <LI>
          ...
          anestesia, sedação e o que esperar durante a cirurgia.
        </LI>
        <LI>
          <Link href="/blog/sedacao-transplante-capilar" className="underline">
            Sedação no transplante capilar
          </Link>:{" "}
          como funciona e a segurança do procedimento.
        </LI>
        <LI>
          <Link href="/blog/recuperacao-transplante-capilar" className="underline">
            Recuperação do transplante capilar
          </Link>:{" "}
          cuidados e cronograma dos primeiros dias.
        </LI>
      </UL>
      ...
      <UL>
        <LI>
          ...
          a linha do tempo mês a mês, da queda inicial ao resultado final.
        </LI>
        <LI>
          <Link href="/blog/antes-e-depois-transplante-capilar" className="underline">
            Antes e depois do transplante capilar
          </Link>:{" "}
          como analisar fotos de resultado com critério.
        </LI>
        <LI>
          <Link href="/blog/sinais-transplante-capilar-mal-feito" className="underline">
            Sinais de transplante capilar mal feito
          </Link>:{" "}
          o que observar, e quando vale buscar uma correção.
        </LI>
        <LI>
          <Link href="/blog/transplante-capilar-e-definitivo" className="underline">
            Transplante capilar dura para sempre?
          </Link>:{" "}
          a durabilidade dos fios e o papel do tratamento clínico complementar.
        </LI>
      </UL>

      <Callout>
        Este conteúdo tem caráter educativo e não substitui uma consulta
        médica. O planejamento cirúrgico depende de avaliação individual da
        área doadora e do padrão de calvície.
      </Callout>

      <P>
        Se você já entendeu o processo e quer saber como ele se aplica ao seu
        caso, o próximo passo é uma avaliação com o Dr. Vitor Frauches.{" "}
