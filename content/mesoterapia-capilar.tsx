...
export default function Article() {
  return (
    <>
      ...
      <UL>
        <LI><a href="https://pubmed.ncbi.nlm.nih.gov/38841017/" className="underline" target="_blank" rel="noopener noreferrer">{"Aledani EM et al. Mesotherapy as a promising alternative to minoxidil. 2024."}</a></LI>
        <LI><a href="https://pubmed.ncbi.nlm.nih.gov/35816059/" className="underline" target="_blank" rel="noopener noreferrer">{"Saceda-Corralo D et al. Mesotherapy with dutasteride. 2022."}</a></LI>
        <LI><a href="https://pubmed.ncbi.nlm.nih.gov/39278205/" className="underline" target="_blank" rel="noopener noreferrer">{"Ding Y et al. Dutasteride for androgenetic alopecia."}</a></LI>
      ...
      <P>{"Se você quer se aprofundar, veja também nossos artigos sobre "}<Link href="/blog/mmp-capilar" className="underline">{"MMP capilar"}</Link>{" e sobre "}<Link href="/blog/prp-para-queda-de-cabelo" className="underline">{"PRP para queda de cabelo"}</Link>{". Para entender como isso se aplica ao seu caso, o próximo passo é uma avaliação com o Dr. Vitor Frauches. "}<a href={WHATSAPP_URL} className="underline" target="_blank" rel="noopener noreferrer"><Strong>{"Agende pelo WhatsApp"}</Strong></a>{"."}</P>
