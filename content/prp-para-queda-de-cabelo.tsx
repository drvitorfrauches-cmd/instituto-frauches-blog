...
export const meta: PostMeta = {
  ...
  author: AUTHOR,
  coverImage: {
    src: "/blog/prp-para-queda-de-cabelo/cover.jpg",
    alt: "Tubo de ensaio com sangue centrifugado, mostrando a separação do plasma na parte superior, representando o material usado no PRP para queda de cabelo",
  },
};
...
export default function Article() {
  return (
    <>
      ...
      <UL>
        <LI><a href="https://pubmed.ncbi.nlm.nih.gov/41219547/" className="underline" target="_blank" rel="noopener noreferrer">{"Umar M et al. Comparative efficacy and safety of PRP versus topical minoxidil."}</a></LI>
        <LI><a href="https://pubmed.ncbi.nlm.nih.gov/42465074/" className="underline" target="_blank" rel="noopener noreferrer">{"Balwi A et al. Adjunctive regenerative therapies in hair transplantation. 2026."}</a></LI>
        <LI><a href="https://pubmed.ncbi.nlm.nih.gov/34741573/" className="underline" target="_blank" rel="noopener noreferrer">{"Nestor MS et al. Treatment options for androgenetic alopecia."}</a></LI>
      </UL>
      <P>{"Se você quer se aprofundar, veja também nossos artigos sobre "}<Link href="/blog/calvicie-tem-cura" className="underline">{"calvície tem cura"}</Link>{" e sobre "}<Link href="/blog/minoxidil-para-queda-de-cabelo" className="underline">{"se o minoxidil funciona"}</Link>{". Para entender como isso se aplica ao seu caso, o próximo passo é uma avaliação com o Dr. Vitor Frauches. "}<a href={WHATSAPP_URL} className="underline" target="_blank" rel="noopener noreferrer"><Strong>{"Agende pelo WhatsApp"}</Strong></a>{"."}</P>
