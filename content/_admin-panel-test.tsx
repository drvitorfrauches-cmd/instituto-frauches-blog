...
export default function Article() {
  return (
    <>
      <P>
        Este é um parágrafo de teste pra você experimentar o painel: tente
        apagar uma frase, adicionar outra, ou colocar algo em negrito.
      </P>

      <H2 id="secao-teste">Uma seção de teste</H2>
      <P>
        Outro parágrafo, este com um link pro{" "}
        <Link href="/blog/guia-transplante-capilar" className="underline">
          guia do transplante capilar
        </Link>
        . Edite este texto à vontade pra ver como o link se comporta depois
        de salvar.
      </P>
      ...
      <Callout>
        Este conteúdo é só um teste técnico e será removido do blog depois
        que você validar o painel.
      </Callout>
