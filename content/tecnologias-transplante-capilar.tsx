...
export default function Article() {
  return (
    <>
      ...
      <P>Pode ajudar em protocolos, mas não compensa trauma.</P>
      <H3>PRP garante crescimento?</H3>
      <P>Não. Pode ser adjuvante.</P>
      <H3>DHI é diferente de FUE?</H3>
      <P>FUE descreve extração; DHI costuma descrever implantação com implanter.</P>
      <H3>IA consegue prever resultado?</H3>
      <P>Pode simular, mas não prever biologia com certeza.</P>
      ...
      <UL>
        ...
        <LI><a href="https://pubmed.ncbi.nlm.nih.gov/38509585/" target="_blank" rel="noopener noreferrer" className="underline">Platelet-rich plasma for androgenetic alopecia.</a></LI>
